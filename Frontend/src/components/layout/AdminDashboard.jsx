...
function AdminDashboard() {
    ...
    return (
        <div className="container mx-auto lg:px-48 md:px-5 sm:px-5 min-h-screen bg-gray-100 dark:bg-gray-900 text-gray-800 dark:text-gray-200 transition-colors duration-300 py-24">
